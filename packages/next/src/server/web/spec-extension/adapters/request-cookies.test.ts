...
describe('wrapWithMutableAccessCheck', () => {
  ...
  beforeAll(() => {
    ;(globalThis as any).AsyncLocalStorage ??=
      (require('node:async_hooks') as typeof import('node:async_hooks')).AsyncLocalStorage
    jest.resetModules()
    workUnitAsyncStorage =
      (require('../../../app-render/work-unit-async-storage.external') as typeof import('../../../app-render/work-unit-async-storage.external')).workUnitAsyncStorage
    createCookiesWithMutableAccessCheck =
      (require('./request-cookies') as typeof import('./request-cookies')).createCookiesWithMutableAccessCheck
  })
